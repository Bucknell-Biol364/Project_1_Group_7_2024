...
I want you to think about the other available statistical tests which are available to us in R, and which would be appropriate for completing the task of comparing bill lengths between sexes on Torsergen Island. What would this look like as code?

```{r}
t.test(bill_length_mm ~ sex, data = torgersenpen)
```

Why would we want to use this type of statistical test as opposed to an anova? What are the advantages and/or disadvantages? 
